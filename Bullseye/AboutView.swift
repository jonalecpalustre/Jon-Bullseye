...
//  Bullseye
//
//  Created by Jolec Palustre on 8/2/20.
...
struct AboutView: View {
    ...
    Group {
        VStack {
            ...
            Text("This is Bullseye, the game where you can points and earn fame by dragging a slider.").modifier(TextStyle())
            ...
            Text("- Jon Palustre, 2020").modifier(TextStyle())
